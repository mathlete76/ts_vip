...
export const Landing: FC = () => {
    ...
    const [vipAccountChecked, setVipAccountChecked] = useState(false);
    ...
    useEffect(() => {
        if (ourWallet) {
            if (!vipAccountChecked) {
                checkVIPAccount();
                setVipAccountChecked(true);
            }
        } else {
            // Reset vipAccountChecked to false when the wallet is disconnected
            setVipAccountChecked(false);
        }
    }, [ourWallet, checkVIPAccount, vipAccountChecked]);
